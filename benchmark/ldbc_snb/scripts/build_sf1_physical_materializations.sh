...
RESULTS_DIR="results/physical_materialization/sf1_full_comparison_consolidated"
...
echo "============================================================" | tee "$LOG_FILE"
echo "Building LDBC SNB SF1 physical MongoDB materializations" | tee -a "$LOG_FILE"
