...
MANIFEST="results/physical_materialization/sf1_full_comparison_consolidated/materialization/physical_materialization_manifest.csv"
OUT_BASE="results/physical_benchmark/ldbc_snb_sf1_full_10cold_10hot"
...
echo "============================================================"
echo "LDBC SNB SF1 full physical benchmark"
...
if q == "IC1":
    path = base / "sf1_parameter_pools/ic1_parameter_pairs.csv"
elif q == "IC3":
    path = base / "sf1_parameter_pools/ic3_parameter_triples.csv"
elif q == "IC4":
    path = base / "sf1_parameter_pools/ic4_parameter_ids.csv"
elif q == "IC6":
    path = base / "sf1_parameter_pools/ic6_parameter_pairs.csv"
elif q == "IC7":
    path = base / "sf1_parameter_pools/ic7_parameter_ids.csv"
elif q.startswith("IC"):
    path = base / "sf1_parameter_pools/ic_parameter_pools.csv"
elif q.startswith("IS"):
    path = base / "sf1_parameter_pools/is_parameter_pools.csv"
elif q.startswith("INS"):
    path = base / "sf1_parameter_pools/ins_parameter_pools.csv"
else:
...
echo ""
echo "All SF1 10 cold + 10 hot runs completed."
