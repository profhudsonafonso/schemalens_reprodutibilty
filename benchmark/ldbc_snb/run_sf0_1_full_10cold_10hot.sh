...
MANIFEST="results/physical_materialization/sf0_1_full_comparison_consolidated/materialization/physical_materialization_manifest.csv"
OUT_BASE="results/physical_benchmark/ldbc_snb_sf0_1_full_10cold_10hot"
...
echo "============================================================"
echo "LDBC SNB SF0.1 full physical benchmark"
...
if q == "IC1":
    path = base / "ic_parameter_pools_sf0_1/ic1_parameter_pairs.csv"
elif q == "IC3":
    path = base / "ic_parameter_pools_sf0_1/ic3_parameter_triples.csv"
elif q == "IC4":
    path = base / "ic_parameter_pools_sf0_1/ic4_parameter_ids.csv"
elif q == "IC6":
    path = base / "ic_parameter_pools_sf0_1/ic6_parameter_pairs.csv"
elif q == "IC7":
    path = base / "ic_parameter_pools_sf0_1/ic7_parameter_ids.csv"
elif q.startswith("IC"):
    path = base / "ic_parameter_pools_sf0_1/ic_parameter_pools.csv"
elif q.startswith("IS"):
    path = base / "is_parameter_pools_sf0_1/is_parameter_pools.csv"
elif q.startswith("INS"):
    path = base / "ins_parameter_pools_sf0_1/ins_parameter_pools.csv"
else:
...
echo ""
echo "All SF0.1 10 cold + 10 hot runs completed."
